...
| **Device Settings** | Three items on the Options menu. The fourth is new: a page listing both players' pad bindings in the style of Game Settings. ENTER on an action asks for a button; nothing answers yet - the pad itself follows. |
