...
| starting | 2 + section | exe `0x4373c8`, `0x4365bf` (files `0x367c8`, `0x359bf`; American `0x36af8`, `0x35cef`; Australian `0x601e8`, `0x5f3df`): the two `call 0x438dc0`, the race setup, from the host's START and the guest's on the host's word; the annex |
