...
| starting | 4 + section | exe `0x4373c8`, `0x4365bf` (files `0x367c8`, `0x359bf`; American `0x36af8`, `0x35cef`; Australian `0x601e8`, `0x5f3df`): the two `call 0x438dc0`, the race setup, from the host's START and the guest's on the host's word; `0x435f58` (file `0x35358`; American `0x35688`, Australian `0x5ed78`): the room's draw `0x436310` as the init pushes it, the annex's second entry instead; `0x435c02` (file `0x35002`; American `0x35332`, Australian `0x5ea22`): the init's `call 0x406fa0`, the surface load, through the third; the annex |
