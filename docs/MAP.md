...
| lobby | 18 + 2 sections + art | exe `0x43cb4e` (file `0x3bf4e`, the annex's address check), `0x420f10`, `0x41fef1`, `0x420849`, `0x4203ba`, `0x420cd5` (files `0x20310`, `0x1f2f1`, `0x1fc49`, `0x1f7ba`, `0x200d5`, the entry caps and the paste), `0x4350e4` (file `0x344e4`, the chat line's block), `0x43bd58`, `0x43bd76` (50 bytes), `0x43bda8`, `0x43bdcc`, `0x43bddd`, `0x43bf57`, `0x43bf77`, `0x43bf85`, `0x43bfcf`, `0x4400dd`, `0x43efe0` (files `0x3b158`, `0x3b176`, `0x3b1a8`, `0x3b1cc`, `0x3b1dd`, `0x3b357`, `0x3b377`, `0x3b385`, `0x3b3cf`, `0x3f4dd`, `0x3e3e0`; the other builds' anchors in `BUILDS`); `BINDATA\connect\PROTOCOL\CONNECT.BMP` repainted, `CONNECT_{IPX,TCPIP,MODEM}_{OFF,ON,ON2}.BMP` and `button\showteam_*.BMP` rewritten, `IP_ENTRY\Ip_entry_US.bmp` redrawn under the box |
