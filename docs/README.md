...
| Read | For |
| --- | --- |
| [NOTES.md](NOTES.md) | how the game works and what each patch changes: the executable and its DLLs, the builds and their fingerprints, the processor check, Musashi and the manifests, the registry, startup, the loader, activation, music, both discs and the `data1.cab` format |
