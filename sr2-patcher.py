...
BUILDS = {
    'European': {
        ...
        'sites': {'check': 0x267c0, 'loader': 0x7572e, 'activate': 0x25ff7,
                  ...
                  'volume': 0x1db0},        # in MGAudio.dll: the CD-volume method
    ...
    'Australian': {
        ...
        'sites': {'check': 0x4b420, 'loader': 0xb4dbe, 'activate': 0x4abfd,
                  ...
                  'volume': 0x1d90, 'mixer': 0x2278},     # both in MGAudio.dll
...
# music:   one site, the CD-volume method's entry (0x10001db0), which
#          becomes a jump to the blob's setvolume, so the BGM slider sets
#          the wave volume the tracks play at; the rest is apply_music,
...
def patches(build):
    ...
    table = {
        ...
        'music': ('MUSASHI\\MGAudio.dll', ((site['volume'], bytes.fromhex('53568b74240c'), None),), 'apply_music'),
    }
    if 'oscheck' in site:
...
MUSIC_BLOB = bytes.fromhex(
    'e990020000e931050000e912000000e92d020000e8000000005b81eb19000000'
    ...
    '005bc331c031c98a0e80e93080f90977086bc00a01c846ebeec3ffb3b8070000'
    'ff93b00700006affffb3bc070000ff93b40700008b83e80d0000c3e874ffffff'
    '6affffb3b8070000ff93b40700006a006a208d83c80d0000508d83c80b000050'
    'ff93980700008983e80d0000ffb3bc070000ff93b0070000ebc689c1c1e9080f'
    ...
    '59c1e20809d009c8c38dbb5c09000003bb94070000e8b9feffff8db30a0b0000'
    'e8a6feffffc3898388070000508dbbc80b00008db30f0b0000e88dfeffffe8d7'
    'feffffc7838c0700000000000058e8b6ffffff8dbbc80b00008db31c0b0000e8'
    '67feffff8db35c090000e85cfeffff8db3230b0000e851feffffe89bfeffff85'
    'c0752c8dbbc80b00008db3410b0000e837feffffe881feffffc7838c07000001'
    '000000c783c80700000100000031c0c383bbc807000000742783bbc007000000'
    '741e60ffb3c40700006a00ff93c007000085c0750ac783c80700000000000061'
    'c353e8cdfdffff8b44240c85c0744083780800743a8b400c3d102700007605b8'
    '1027000069c0ffff000031d2b910270000f7f189c2c1e21009d08983c4070000'
    'c783c807000001000000e881ffffff31c05bc20c005589e5535657e874fdffff'
    '8b450c3d03080000753e83bb84070000000f84780200008b4d1081e100300000'
    '81f9003000000f85630200008b5514817a08040200000f8553020000c74204ce'
    'fa0000e93e020000817d08cefa00000f853a0200003d0408000074373d060800'
    '00747a3d070800000f84030100003d0808000074383d0908000074413d550800'
    '00744a3d140800000f843f010000e9f30100008db30f0b0000e8d7010000c783'
    '8c07000000000000e9d90100008db3880b0000e8bd010000e9c90100008db394'
    '0b0000e8ad010000e9b90100008db3a10b0000e89d010000e9a90100008b8b90'
    '0700008b8388070000f7451004000000740b8b55148b4204e83dfdffffc78390'
    '0700000000000085c0745c3b8384070000775483bc83cc07000000744a51e8c3'
    'fdffff5985c00f855c0100008dbbc80b00008db3650b0000e84efcffff85c974'
