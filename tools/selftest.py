...
EXPECTED_CAPPED = {
    'European': {
        'SEGA RALLY 2.exe': '93e2ccc11bd43727e8f7be21e6fb8f0e',
        'Options.dll': '2b3820776c71a1d79c850cdd20633bcb',
    },
    'American': {
        'SEGA RALLY 2.exe': 'd2a829b07d1c3eae34b447217f28ad54',
        'Options.dll': '2b3820776c71a1d79c850cdd20633bcb',
    },
    'Australian': {
        'SEGA RALLY 2.exe': 'e0971f72d2becba73595903898a5e8f0',
        'Options.dll': '9ece57286ac7c71e5d01bdbeb233a4b2',
    },
    'Japanese (DigiCube, MediaKite)': {
        'SEGA RALLY 2.exe': '885f7493d92f73e278fc3b76ceb15f8a',
        'Options.dll': '2b3820776c71a1d79c850cdd20633bcb',
    },
}
EXPECTED = {
    'European': {
        'SEGA RALLY 2.exe': 'd08f52626a6d8f8c6591aec9931c0191',
        ...
        'MUSASHI\\MGNetWk.dll': '0a93fb8f18724696f512558df2c7956f',
    ...
    'American': {
        'SEGA RALLY 2.exe': '593a55cc2ed15b342141e913077eff4f',
        'MUSASHI\\MGameGL.dll': '0dddd6b6300d818c009d409043b2424c',
        'MUSASHI\\MGameD3D.dll': '31516b1229bb5922bc61f9b1daf8fb89',
        'MUSASHI\\MGAudio.dll': '7793a537317e3a45dd51c1776af63e90',
        'MUSASHI\\MGSound.dll': 'f53d3c4ca507da0f04e8a81f0882388b',
    ...
    'Australian': {
        'SEGA RALLY 2.exe': '151f711d9921fabfcaa877c263535514',
        'MUSASHI\\MGameGL.dll': '0dddd6b6300d818c009d409043b2424c',
        'MUSASHI\\MGameD3D.dll': '31516b1229bb5922bc61f9b1daf8fb89',
    ...
    'Japanese (DigiCube, MediaKite)': {
        'SEGA RALLY 2.exe': 'bac6575c9ebe3b72d65f1414996f6169',
        'MUSASHI\\MGameGL.dll': '0dddd6b6300d818c009d409043b2424c',
        'MUSASHI\\MGameD3D.dll': '31516b1229bb5922bc61f9b1daf8fb89',
        'MUSASHI\\MGAudio.dll': '7793a537317e3a45dd51c1776af63e90',
        'MUSASHI\\MGSound.dll': 'f53d3c4ca507da0f04e8a81f0882388b',
