...
| `devices.asm` | in `Options.dll`: the Device Settings page's two states, init and exec, over the sprites, quads and draw list the patcher builds after it; `DEVICES_MAGICS` are its placeholders |
